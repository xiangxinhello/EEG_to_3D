...
class cond_stage_model(nn.Module):
    def __init__(self, metafile, num_voxels=440, cond_dim=1280, global_pool=True, clip_tune = True, cls_tune = False , device = None):
        ...
        # cnn_class_embedding
        self.cnn_path = '/root/autodl-tmp/DreamDiffusion/class_cnn_model.ckpt'
        self.num_classes = 40
        ...
        self.transformer_path = '/root/autodl-tmp/DreamDiffusion/ImageNetClass_TransformerEncoder_3382_0.9469_0.8851_0.8992_weights.pth'
...
class eLDM:
    ...
    def __init__(self, metafile, num_voxels, device=torch.device('cpu'),
        ...
        self.ckp_path = '/root/autodl-tmp/DreamDiffusion/v1-5-pruned.ckpt'
#         self.ckp_path = '/root/autodl-tmp/DreamDiffusion/dreamdiffusion/exps/results/generation/15-11-2023-09-44-35/checkpoint_best.pth'
        ...
        self.config_path = '/root/autodl-tmp/DreamDiffusion/pretrains/models/config15.yaml'

        #todo class_embedding
        self.cnn_path = '/root/autodl-tmp/DreamDiffusion/cnn_model.ckpt'
