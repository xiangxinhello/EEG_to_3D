...
#     parser.add_argument('--model_path', type=str,default='/root/autodl-tmp/DreamDiffusion/dreamdiffusion/exps/results/generation/27-10-2023-21-02-15/checkpoint_best1019.pth')
#     parser.add_argument('--model_path', type=str,default='/root/autodl-tmp/DreamDiffusion/dreamdiffusion/exps/results/generation/15-11-2023-09-44-35/checkpoint_best.pth')
...
#     config.pretrain_mbm_path = '/root/autodl-tmp/DreamDiffusion/dreamdiffusion/results/eeg_pretrain/14-10-2023-08-46-31/checkpoints/checkpoint.pth'
